            ...
            <div class="project__description">
                ...
                <div>
                    ...
                    <div class="project__achievement">
                        <p v-for="achievement in getAchievements(project)" :key="achievement">{{ achievement }}</p>
                    </div>
                </div>
                <div class="project__footer" v-if="getLinks(project)">
                    <a v-for="link in getLinks(project)" :href="link.url || link.href" target="_blank" :key="link.url">{{ link.text }}</a>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        getAchievements(project: Project): string[] {
            return Array.isArray(project.achievements) ? project.achievements : project.achievements.content || [];
        },
